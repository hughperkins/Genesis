...
class RigidSolver(Solver):
    ...
    def convert_to_python_objs(self, params):
        import torch
        import dataclasses
        if isinstance(params, tuple):
            res = []
            for param in params:
                _res = self.convert_to_python_objs(param)
                res.append(_res)
            return tuple(res)
    ...
    def dump_params(self, pickle_filepath, params):
        import pickle, os
    ...
    def update_verts_for_geoms(self, geoms_idx):
        ...
        self.dump_params("/tmp/params.pkl", params)
