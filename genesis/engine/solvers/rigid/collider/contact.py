...
def func_add_contact(
    ...
    # Atomically allocate contact slot to avoid race conditions when multiple threads
    # process collisions from the same environment (e.g., with global collision queue)
