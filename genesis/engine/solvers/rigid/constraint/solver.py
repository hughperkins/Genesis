...
def func_ls_point_fn_opt_coop(
    ...
    quad_total_0 = gs.qd_float(0.0)
    quad_total_1 = gs.qd_float(0.0)
    quad_total_2 = gs.qd_float(0.0)
    if tid == 0:
        quad_total_0 = constraint_state.quad_gauss[0, i_b] + constraint_state.eq_sum[0, i_b]
        quad_total_1 = constraint_state.quad_gauss[1, i_b] + constraint_state.eq_sum[1, i_b]
        quad_total_2 = constraint_state.quad_gauss[2, i_b] + constraint_state.eq_sum[2, i_b]
    ...
    quad_total_2 = qd.simt.subgroup.reduce_all_add(quad_total_2, 5)
...
def func_ls_point_fn_3alphas_opt_coop(
    ...
    t0_2 = qd.simt.subgroup.reduce_all_add(t0_2, 5)
    t1_0 = qd.simt.subgroup.reduce_all_add(t1_0, 5)
    t1_1 = qd.simt.subgroup.reduce_all_add(t1_1, 5)
    t1_2 = qd.simt.subgroup.reduce_all_add(t1_2, 5)
    t2_0 = qd.simt.subgroup.reduce_all_add(t2_0, 5)
    t2_1 = qd.simt.subgroup.reduce_all_add(t2_1, 5)
    t2_2 = qd.simt.subgroup.reduce_all_add(t2_2, 5)
