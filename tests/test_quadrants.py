...
def gs_static_child(args: list[str]):
    ...
    assert (
        func_narrow_phase_convex_specializations._primal.src_ll_cache_observations.cache_key_generated
        == args.expected_use_src_ll_cache
    )
    assert (
        func_narrow_phase_convex_specializations._primal.src_ll_cache_observations.cache_validated
        == args.expected_src_ll_cache_hit
    )
    assert (
        func_narrow_phase_convex_specializations._primal.src_ll_cache_observations.cache_loaded
        == args.expected_src_ll_cache_hit
    )
